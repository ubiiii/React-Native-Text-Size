...
There are two primary operations: "flatHeights," which may be used to concurrently determine the height of several blocks of text and is best for [`<FlatList>`][0] or [`<RecyclerListView>`][1].
